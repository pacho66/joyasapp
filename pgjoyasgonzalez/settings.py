...
"""
Django settings for pgjoyasgonzalez project.
...
STORAGES = {
    ...
    "staticfiles": {
        "BACKEND": "django.contrib.staticfiles.storage.StaticFilesStorage", # 🌟 Cambia esta línea
    },
}
...
ROOT_URLCONF = 'pgjoyasgonzalez.urls'
...
WSGI_APPLICATION = 'pgjoyasgonzalez.wsgi.application'
...
EMAIL_HOST_USER = 'plateria.gonzalez73@gmail.com'
EMAIL_HOST_PASSWORD = 'ndck visz rgcd dahf'
...
print("WOMPI PUBLIC:", os.getenv("WOMPI_PUBLIC_KEY"))